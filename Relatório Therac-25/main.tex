...
\begin{itemize}
    ...
    \item \textbf{Falha (Failure):} O tratamento que deveria ser um feixe de elétrons para um tratamento de tumor superficial, acabou disparando um feixe de altíssima intensidade de raios X em um paciente sem proteção \cite{harvard_investigation}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Fase de criação:} Desenvolvimento (Development). Defeitos como a condição de corrida e Integer Overflow da variável Class3 foram injetados estritamente durante a fase de elaboração do projeto do código pela fabricante.  
